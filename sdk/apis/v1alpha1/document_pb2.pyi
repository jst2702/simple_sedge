...
class Document(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_ticker", b"_ticker", "body", b"body", "guid", b"guid", "headline", b"headline", "language", b"language", "published", b"published", "site", b"site", "site_full", b"site_full", "site_section", b"site_section", "ticker", b"ticker", "tickers", b"tickers", "title", b"title", "url", b"url"]) -> None: ...
