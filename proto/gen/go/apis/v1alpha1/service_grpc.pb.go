...
func (c *simpleSedgeClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/apis.SimpleSedge/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *simpleSedgeClient) LoginUser(ctx context.Context, in *LoginUserRequest, opts ...grpc.CallOption) (*LoginUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/apis.SimpleSedge/LoginUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *simpleSedgeClient) UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...grpc.CallOption) (*UpdateUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/apis.SimpleSedge/UpdateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *simpleSedgeClient) VerifyEmail(ctx context.Context, in *VerifyEmailRequest, opts ...grpc.CallOption) (*VerifyEmailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/apis.SimpleSedge/VerifyEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *simpleSedgeClient) ListDocuments(ctx context.Context, in *ListDocumentsRequest, opts ...grpc.CallOption) (*ListDocumentsResponse, error) {
	out := new(ListDocumentsResponse)
	err := c.cc.Invoke(ctx, "/apis.SimpleSedge/ListDocuments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *simpleSedgeClient) IngestDocument(ctx context.Context, in *IngestDocumentRequest, opts ...grpc.CallOption) (*IngestDocumentResponse, error) {
	out := new(IngestDocumentResponse)
	err := c.cc.Invoke(ctx, "/apis.SimpleSedge/IngestDocument", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSimpleSedgeServer) ListDocuments(context.Context, *ListDocumentsRequest) (*ListDocumentsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListDocuments not implemented")
}
func (UnimplementedSimpleSedgeServer) IngestDocument(context.Context, *IngestDocumentRequest) (*IngestDocumentResponse, error) {
...
func _SimpleSedge_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apis.SimpleSedge/CreateUser",
	}
...
func _SimpleSedge_LoginUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apis.SimpleSedge/LoginUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SimpleSedge_UpdateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apis.SimpleSedge/UpdateUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SimpleSedge_VerifyEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apis.SimpleSedge/VerifyEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SimpleSedge_ListDocuments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListDocumentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleSedgeServer).ListDocuments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apis.SimpleSedge/ListDocuments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleSedgeServer).ListDocuments(ctx, req.(*ListDocumentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SimpleSedge_IngestDocument_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IngestDocumentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleSedgeServer).IngestDocument(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apis.SimpleSedge/IngestDocument",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleSedgeServer).IngestDocument(ctx, req.(*IngestDocumentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SimpleSedge_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SimpleSedge_ListDocuments_Handler,
		},
		{
			MethodName: "IngestDocument",
			Handler:    _SimpleSedge_IngestDocument_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "apis/v1alpha1/service.proto",
}
