...
func RegisterIngestionServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IngestionServiceServer) error {
	...
	mux.Handle("POST", pattern_IngestionService_IngestDocument_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/processing.v1alpha1.IngestionService/IngestDocument", runtime.WithHTTPPathPattern("/processing/v2alpha1/documents/ingest"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_IngestionService_IngestDocument_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_IngestionService_IngestDocument_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterIngestionServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client IngestionServiceClient) error {
	...
	mux.Handle("POST", pattern_IngestionService_IngestDocument_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/processing.v1alpha1.IngestionService/IngestDocument", runtime.WithHTTPPathPattern("/processing/v2alpha1/documents/ingest"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_IngestionService_IngestDocument_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_IngestionService_IngestDocument_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"processing", "v2alpha1", "documents", "ingest"}, ""))
)
