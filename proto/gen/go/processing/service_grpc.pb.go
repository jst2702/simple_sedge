...
func (c *ingestionServiceClient) IngestDocument(ctx context.Context, in *IngestDocumentRequest, opts ...grpc.CallOption) (*IngestDocumentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/processing.IngestionService/IngestDocument", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ingestionServiceClient) ListDocuments(ctx context.Context, in *ListDocumentsRequest, opts ...grpc.CallOption) (*ListDocumentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/processing.IngestionService/ListDocuments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _IngestionService_IngestDocument_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/processing.IngestionService/IngestDocument",
	}
...
func _IngestionService_ListDocuments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/processing.IngestionService/ListDocuments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var IngestionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "processing.IngestionService",
	...
	Metadata: "processing/service.proto",
}
